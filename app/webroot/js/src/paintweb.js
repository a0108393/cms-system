...
function PaintWeb (win, doc) {
  ...
  */
  ...
  this.historyGoto = function (pos) {
    ...
    if (pos === 'undo') {
   var parentnode = doc.getElementById('discussion');
    var child = doc.getElementById('discussionChild'.concat(history.count.toString()));
   ...
   document.getElementById('discussion').innerHTML = "";
	...
	x.setAttribute("id", "discussionChild".concat(i.toString()));
    x.setAttribute("type", "text");
    x.setAttribute("value", "fill in description");
	x.setAttribute("class","form-control");
	document.getElementById("discussion").appendChild(value);
    document.getElementById("discussion").appendChild(x);
		}
	...
	this.events.dispatch(new appEvent.historyUpdateCount(history.count));
  ...
  this.historyReset = function () {
    ...
    this.events.dispatch(new appEvent.historyUpdateCount(0));
  };
