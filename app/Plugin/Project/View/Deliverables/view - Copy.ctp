    ...
    */
	...
	foreach($allChanges as $change){
       ...
       /* echo  '<div id="room_fileds">';
        echo  '<div>';
        echo  '<div class="label">Room 1:</div>';
        echo  '<div class="content">';
        echo  '<span>Width: <input type="text" style="width:48px;" name="width[]" value="" /><small>(ft)</small> X </span>';
        echo  '<span>Length: <input type="text" style="width:48px;" namae="length[]" value="" /><small>(ft)</small></span>';
        echo  '</div>';
        echo  '</div>';
        echo  '</div>';
		*/
